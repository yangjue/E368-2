...
/// \file FreeRTOSConfig.h configuration for freeRTOS stuff
...
//uncomment to enable led trace functionality
/*#define traceTASK_SWITCHED_IN() \
	AT91C_BASE_PIOB->PIO_SODR = (0xf << 22); \
	AT91C_BASE_PIOB->PIO_CODR = ((unsigned int)(pxCurrentTCB->pxTaskTag) << 22);*/
